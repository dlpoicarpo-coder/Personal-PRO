  ...
  if (!document.querySelector('.sidebar')) {
    appContainer.innerHTML = `
      ...
      <nav id="mobileBottomNav" role="navigation" aria-label="Navegação mobile">
        ...
        <button class="mobile-nav-item" data-route="/treinos" aria-label="Treinos">
          <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2"/><rect x="8" y="2" width="8" height="4" rx="1" ry="1"/><line x1="9" y1="12" x2="15" y2="12"/><line x1="9" y1="16" x2="13" y2="16"/></svg>
          <span>Treinos</span>
        </button>
        ...
        <button class="mobile-nav-item" data-route="/biofeedback" aria-label="Biofeedback">

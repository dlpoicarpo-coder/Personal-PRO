// ========================================
// VETOR — Scientific Biofeedback Alerts
// ========================================
...
export const PAIN_REGIONS = [
  ...
  { id: 'wrist_r',     label: 'Punho/Mão Dir.',       group: 'Ombros/Braços'   },
  { id: 'wrist_l',     label: 'Punho/Mão Esq.',       group: 'Ombros/Braços'   },
  // Tronco
  ...
  { id: 'mid_back',    label: 'Torácica',             group: 'Tronco'          },
  ...
  // Pernas
  { id: 'quad_r',      label: 'Quadríceps Dir.',      group: 'Pernas'          },
  { id: 'quad_l',      label: 'Quadríceps Esq.',      group: 'Pernas'          },
